% {{PROJECT_NAME}}(SECTION) | User Commands
%
% "{{RELEASE_DATE}}"
...
{{PROJECT_NAME}} - program to do something

# SYNOPSIS

**{{PROJECT_NAME}}** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
...
:   The system-wide configuration file to control the behaviour of
    {{PROJECT_NAME}}. See **foo.conf**(5) for further details.
...
**{{PROJECT_NAME}}** provides some return codes, that can be used in scripts:
...
Copyright © {{RELEASE_YEAR}} {{MAINTAINER_NAME}}
